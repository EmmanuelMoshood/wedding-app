...
import { CreateInvitationWithGuest } from "@/components/invitations/create-with-guest";

export const Guests = () => {
  const [value, setValue] = useState("");
  const {
    isOpen: isCreateInvitationWithGuestOpen,
    onOpen: openCreateInvitationWithGuest,
    onClose: onCreateInvitationWithGuestClose,
  } = useDisclosure();
    ...
    <>
      ...
      >
        ...
        <Stack spacing={4} direction={"row"} align="end" justify={"end"} py={4}>
          <Button borderRadius={"4px"} fontWeight={400} px={6} disabled={true}>
            Upload Spreadsheet
          </Button>
          ...
          <Button
            ...
            onClick={openCreateInvitationWithGuest}
          >
            Add Guest
          </Button>
